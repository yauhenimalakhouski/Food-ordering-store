...
export const AnimationBg = () => {
    return (
        <div className={styles.root}>
            <p className={classNames(styles.header, styles.head1)}>Awesome designs</p>
            <p className={classNames(styles.header, styles.head2)}>Just</p>
            <p className={classNames(styles.header, styles.head3)}>For you</p>
            <p className={classNames(styles.header, styles.head4)}>simple and awesome all the time</p>
            <p className={classNames(styles.header, styles.head5)}>Welcome to BA designs</p>
